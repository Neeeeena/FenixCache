...
#ifndef INSERTZIGZAGSTRESSTESTEVENTLISTENER_HPP
# define INSERTZIGZAGSTRESSTESTEVENTLISTENER_HPP
...
class InsertZigZagStressTestEventListener : public EventListener
{
 public:
  inline
              ...
              register const class Event* const incomingEvent)
  {
   ...
   for(unsigned int index = 0; index < 1000; index++)
   {
    ...
    const uint64_t minor = index>600 ? 600 - (index-600) : index;
