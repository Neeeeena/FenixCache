...
#ifndef INSERTREMOVESTRESSTESTEVENTLISTENER_HPP
# define INSERTREMOVESTRESSTESTEVENTLISTENER_HPP
...
class InsertRemoveStressTestEventListener : public EventListener
{
 public:
  inline
