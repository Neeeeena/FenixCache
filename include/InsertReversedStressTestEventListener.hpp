...
#ifndef INSERTREVERSEDSTRESSTESTEVENTLISTENER_HPP
# define INSERTREVERSEDSTRESSTESTEVENTLISTENER_HPP
...
class InsertReversedStressTestEventListener : public EventListener
{
 public:
  inline
              ...
              register const class Event* const incomingEvent)
  {
   ...
   for(unsigned int index = 1000; index > 0; index--)
   {
